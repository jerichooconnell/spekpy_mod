...
from spekpy_mod.IO import full_file, find_file, read_json_from_disk
...
def logarithmic_interpolator(dependent_variables, independent_variables, 
    ...
    interpolater = custom_interp1d(ln_independent_variables, 
...
class BremData:
    ...
    def get_cross_section_interpolator(self):
        ...
        cross_section_interpolator = custom_interp1d(
...
class ElectronData:
    ...
    def get_rg(self):
        ...
        return custom_interp1d(erng, rng)#, bounds_error=False,assume_sorted=True)
